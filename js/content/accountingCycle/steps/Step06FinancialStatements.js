                        ...
                        ${depAssets.map((block, i) => {
                            ...
                            <div key=${i} className="mb-2 bg-gray-50 p-2 rounded relative group">
                                ...
                                <div className="flex justify-between mb-1 text-gray-600">
                                    ...
                                    <div className="w-24 relative"><${FeedbackInput} value=${block.accum} onChange=${(e)=>handleArrChange('depAssets', i, 'accum', e.target.value)} expected=${expAccum} isDeduction={true} showFeedback=${showFeedback} isReadOnly=${isReadOnly} placeholder="0" required=${true} /></div>
                                </div>
