...
export const unit2Week3Data = {
    ...
    // --- NEW WORKSHEET ACTIVITY TYPE ---
    {
        ...
        transactions: [
            ...
            { "date": "Dec 15", "description": "Advance payment received ₱5000.", "rows": 3, "solution": [ { "account": "Cash", "debit": 5000 }, { "account": "Unearned Revenue", "credit": 5000 }, { "account": "To record advance payment received.", "isExplanation": true } ] },
  ...
  {
    "type": "worksheet",
    "id": "WS-SET-A-PERIODIC-FIFO",
    "title": "Worksheet Activity: Set A (Periodic FIFO)",
    "instructions": "Complete the 10-column worksheet. Note: This problem uses the PERIODIC inventory system. Ending Inventory is recorded via adjustment.",
    "transactions": [
      { "date": "Jan 1", "description": "Owner invested ₱200,000 cash.", "rows": 3, "solution": [ { "account": "Cash", "debit": 200000 }, { "account": "Owner's Capital", "credit": 200000 }, { "account": "Initial investment.", "isExplanation": true } ] },
      { "date": "Jan 2", "description": "Paid ₱24,000 for 1-year rent.", "rows": 3, "solution": [ { "account": "Prepaid Rent", "debit": 24000 }, { "account": "Cash", "credit": 24000 }, { "account": "Paid prepaid rent.", "isExplanation": true } ] },
      { "date": "Jan 3", "description": "Purchased goods on account ₱50,000.", "rows": 3, "solution": [ { "account": "Purchases", "debit": 50000 }, { "account": "Accounts Payable", "credit": 50000 }, { "account": "Purchase on account.", "isExplanation": true } ] },
      { "date": "Jan 4", "description": "Paid freight in ₱1,500.", "rows": 3, "solution": [ { "account": "Freight In", "debit": 1500 }, { "account": "Cash", "credit": 1500 }, { "account": "Paid freight.", "isExplanation": true } ] },
      { "date": "Jan 6", "description": "Returned ₱5,000 worth of goods to supplier.", "rows": 3, "solution": [ { "account": "Accounts Payable", "debit": 5000 }, { "account": "Purchase Returns and Allowances", "credit": 5000 }, { "account": "Return to supplier.", "isExplanation": true } ] },
      { "date": "Jan 8", "description": "Sold goods on account ₱80,000.", "rows": 3, "solution": [ { "account": "Accounts Receivable", "debit": 80000 }, { "account": "Sales", "credit": 80000 }, { "account": "Sold goods on credit.", "isExplanation": true } ] },
      { "date": "Jan 10", "description": "Customer returned goods ₱2,000.", "rows": 3, "solution": [ { "account": "Sales Returns and Allowances", "debit": 2000 }, { "account": "Accounts Receivable", "credit": 2000 }, { "account": "Customer return.", "isExplanation": true } ] },
      { "date": "Jan 12", "description": "Purchased supplies ₱3,000 cash.", "rows": 3, "solution": [ { "account": "Supplies", "debit": 3000 }, { "account": "Cash", "credit": 3000 }, { "account": "Bought supplies.", "isExplanation": true } ] },
      { "date": "Jan 15", "description": "Purchased Equipment ₱40,000 on account.", "rows": 3, "solution": [ { "account": "Equipment", "debit": 40000 }, { "account": "Accounts Payable", "credit": 40000 }, { "account": "Bought equipment.", "isExplanation": true } ] },
      { "date": "Jan 18", "description": "Paid supplier in full (no discount).", "rows": 3, "solution": [ { "account": "Accounts Payable", "debit": 45000 }, { "account": "Cash", "credit": 45000 }, { "account": "Paid account.", "isExplanation": true } ] },
      { "date": "Jan 20", "description": "Collected ₱50,000 from customers.", "rows": 3, "solution": [ { "account": "Cash", "debit": 50000 }, { "account": "Accounts Receivable", "credit": 50000 }, { "account": "Collection.", "isExplanation": true } ] },
      { "date": "Jan 25", "description": "Paid advertising ₱2,500.", "rows": 3, "solution": [ { "account": "Advertising Expense", "debit": 2500 }, { "account": "Cash", "credit": 2500 }, { "account": "Paid advertising.", "isExplanation": true } ] },
      { "date": "Jan 26", "description": "Advance payment received ₱5,000.", "rows": 3, "solution": [ { "account": "Cash", "debit": 5000 }, { "account": "Unearned Revenue", "credit": 5000 }, { "account": "To record advance payment received.", "isExplanation": true } ] },
      { "date": "Jan 28", "description": "Owner withdrew ₱5,000.", "rows": 3, "solution": [ { "account": "Owner's Drawings", "debit": 5000 }, { "account": "Cash", "credit": 5000 }, { "account": "Withdrawal.", "isExplanation": true } ] },
      { "date": "Jan 30", "description": "Paid salaries ₱8,000.", "rows": 3, "solution": [ { "account": "Salaries Expense", "debit": 8000 }, { "account": "Cash", "credit": 8000 }, { "account": "Paid salaries.", "isExplanation": true } ] },
      { "date": "Jan 31", "description": "Purchased goods cash ₱10,000.", "rows": 3, "solution": [ { "account": "Purchases", "debit": 10000 }, { "account": "Cash", "credit": 10000 }, { "account": "Cash purchase.", "isExplanation": true } ] }
    ],
    "adjustments": [
      { "date": "Jan 31", "description": "Ending Inventory (Physical Count): ₱22,000.", "rows": 3, "solution": [ { "account": "Merchandise Inventory", "debit": 22000 }, { "account": "Income Summary", "credit": 22000 }, { "account": "To record ending inventory.", "isExplanation": true } ] },
      { "date": "Jan 31", "description": "Rent expired for the month ₱2,000.", "rows": 3, "solution": [ { "account": "Rent Expense", "debit": 2000 }, { "account": "Prepaid Rent", "credit": 2000 }, { "account": "Rent adjustment.", "isExplanation": true } ] },
      { "date": "Jan 31", "description": "Supplies on hand ₱1,000.", "rows": 3, "solution": [ { "account": "Supplies Expense", "debit": 2000 }, { "account": "Supplies", "credit": 2000 }, { "account": "Supplies used.", "isExplanation": true } ] },
      { "date": "Jan 31", "description": "Depreciation on Equipment ₱500.", "rows": 3, "solution": [ { "account": "Depreciation Expense", "debit": 500 }, { "account": "Accumulated Depreciation", "credit": 500 }, { "account": "Depreciation.", "isExplanation": true } ] },
      { "date": "Jan 31", "description": "Accrued Salaries ₱1,500.", "rows": 3, "solution": [ { "account": "Salaries Expense", "debit": 1500 }, { "account": "Accrued Expenses Payable", "credit": 1500 }, { "account": "Accrued salaries.", "isExplanation": true } ] },
      { "date": "Jan 31", "description": "Accrued Utilities ₱800.", "rows": 3, "solution": [ { "account": "Utilities Expense", "debit": 800 }, { "account": "Accrued Expenses Payable", "credit": 800 }, { "account": "Accrued utilities.", "isExplanation": true } ] },
      { "date": "Jan 31", "description": "Earned ₱800 from advanced payment.", "rows": 3, "solution": [ { "account": "Unearned Revenue", "debit": 800 }, { "account": "Sales", "credit": 800 }, { "account": "To record revenue earned.", "isExplanation": true } ] },
    ]
  },
  {
    "type": "worksheet",
    "id": "WS-SET-B-PERPETUAL-FIFO",
    "title": "Worksheet Activity: Set B (Perpetual FIFO)",
    "instructions": "Complete the worksheet. Note: This problem uses the PERPETUAL inventory system. Cost of Goods Sold is recorded at the time of sale.",
    "transactions": [
      { "date": "Feb 1", "description": "Invested ₱150,000 cash.", "rows": 3, "solution": [ { "account": "Cash", "debit": 150000 }, { "account": "Owner's Capital", "credit": 150000 }, { "account": "Initial investment.", "isExplanation": true } ] },
      { "date": "Feb 2", "description": "Purchased merchandise ₱40,000 on account.", "rows": 3, "solution": [ { "account": "Merchandise Inventory", "debit": 40000 }, { "account": "Accounts Payable", "credit": 40000 }, { "account": "Purchased inventory.", "isExplanation": true } ] },
      { "date": "Feb 3", "description": "Paid freight in ₱1,200.", "rows": 3, "solution": [ { "account": "Merchandise Inventory", "debit": 1200 }, { "account": "Cash", "credit": 1200 }, { "account": "Freight on purchase.", "isExplanation": true } ] },
      { "date": "Feb 5", "description": "Sold merchandise ₱60,000 (Cost ₱35,000).", "rows": 5, "solution": [ { "account": "Accounts Receivable", "debit": 60000 }, { "account": "Sales", "credit": 60000 }, { "account": "Cost of Goods Sold", "debit": 35000 }, { "account": "Merchandise Inventory", "credit": 35000 }, { "account": "Sale and COGS.", "isExplanation": true } ] },
      { "date": "Feb 7", "description": "Returned defective goods ₱2,000 to supplier.", "rows": 3, "solution": [ { "account": "Accounts Payable", "debit": 2000 }, { "account": "Merchandise Inventory", "credit": 2000 }, { "account": "Purchase return.", "isExplanation": true } ] },
      { "date": "Feb 9", "description": "Purchased supplies ₱2,500 on account.", "rows": 3, "solution": [ { "account": "Supplies", "debit": 2500 }, { "account": "Accounts Payable", "credit": 2500 }, { "account": "Supplies purchased.", "isExplanation": true } ] },
      { "date": "Feb 10", "description": "Paid insurance for 6 months ₱6,000.", "rows": 3, "solution": [ { "account": "Prepaid Insurance", "debit": 6000 }, { "account": "Cash", "credit": 6000 }, { "account": "Prepaid insurance.", "isExplanation": true } ] },
      { "date": "Feb 12", "description": "Customer returned goods ₱3,000 (Cost ₱1,750).", "rows": 5, "solution": [ { "account": "Sales Returns and Allowances", "debit": 3000 }, { "account": "Accounts Receivable", "credit": 3000 }, { "account": "Merchandise Inventory", "debit": 1750 }, { "account": "Cost of Goods Sold", "credit": 1750 }, { "account": "Sales return.", "isExplanation": true } ] },
      { "date": "Feb 15", "description": "Paid supplier in full less return.", "rows": 3, "solution": [ { "account": "Accounts Payable", "debit": 38000 }, { "account": "Cash", "credit": 38000 }, { "account": "Payment.", "isExplanation": true } ] },
      { "date": "Feb 18", "description": "Sold merchandise ₱20,000 cash (Cost ₱12,000).", "rows": 5, "solution": [ { "account": "Cash", "debit": 20000 }, { "account": "Sales", "credit": 20000 }, { "account": "Cost of Goods Sold", "debit": 12000 }, { "account": "Merchandise Inventory", "credit": 12000 }, { "account": "Cash sale.", "isExplanation": true } ] },
      { "date": "Feb 20", "description": "Collected ₱40,000 from customers.", "rows": 3, "solution": [ { "account": "Cash", "debit": 40000 }, { "account": "Accounts Receivable", "credit": 40000 }, { "account": "Collection.", "isExplanation": true } ] },
      { "date": "Feb 22", "description": "Paid utilities ₱1,500.", "rows": 3, "solution": [ { "account": "Utilities Expense", "debit": 1500 }, { "account": "Cash", "credit": 1500 }, { "account": "Paid utilities.", "isExplanation": true } ] },
      { "date": "Feb 25", "description": "Paid freight out ₱500.", "rows": 3, "solution": [ { "account": "Freight Out", "debit": 500 }, { "account": "Cash", "credit": 500 }, { "account": "Delivery expense.", "isExplanation": true } ] },
      { "date": "Feb 25", "description": "Advance payment received ₱5,000.", "rows": 3, "solution": [ { "account": "Cash", "debit": 5000 }, { "account": "Unearned Revenue", "credit": 5000 }, { "account": "To record advance payment received.", "isExplanation": true } ] },
      { "date": "Feb 27", "description": "Owner withdrew ₱3,000.", "rows": 3, "solution": [ { "account": "Owner's Drawings", "debit": 3000 }, { "account": "Cash", "credit": 3000 }, { "account": "Withdrawal.", "isExplanation": true } ] },
      { "date": "Feb 28", "description": "Paid salaries ₱5,000.", "rows": 3, "solution": [ { "account": "Salaries Expense", "debit": 5000 }, { "account": "Cash", "credit": 5000 }, { "account": "Paid salaries.", "isExplanation": true } ] }
    ],
    "adjustments": [
      { "date": "Feb 28", "description": "Supplies used ₱1,500.", "rows": 3, "solution": [ { "account": "Supplies Expense", "debit": 1500 }, { "account": "Supplies", "credit": 1500 }, { "account": "Supplies adj.", "isExplanation": true } ] },
      { "date": "Feb 28", "description": "Insurance expired ₱1,000.", "rows": 3, "solution": [ { "account": "Insurance Expense", "debit": 1000 }, { "account": "Prepaid Insurance", "credit": 1000 }, { "account": "Insurance adj.", "isExplanation": true } ] },
      { "date": "Feb 28", "description": "Depreciation ₱800.", "rows": 3, "solution": [ { "account": "Depreciation Expense", "debit": 800 }, { "account": "Accumulated Depreciation", "credit": 800 }, { "account": "Depreciation.", "isExplanation": true } ] },
      { "date": "Feb 28", "description": "Accrued Utilities ₱1,200.", "rows": 3, "solution": [ { "account": "Utilities Expense", "debit": 1,200 }, { "account": "Accrued Expenses Payable", "credit": 1,200 }, { "account": "Accrued utilities.", "isExplanation": true } ] },
      { "date": "Feb 28", "description": "Accrued Salaries ₱1,200.", "rows": 3, "solution": [ { "account": "Salaries Expense", "debit": 1200 }, { "account": "Salaries Payable", "credit": 1200 }, { "account": "Accrued Expenses Payable.", "isExplanation": true } ] },
      { "date": "Feb 28", "description": "Unearned Revenue earned ₱500.", "rows": 3, "solution": [ { "account": "Unearned Revenue", "debit": 500 }, { "account": "Sales", "credit": 500 }, { "account": "Revenue earned.", "isExplanation": true } ] },
      { "date": "Feb 28", "description": "Earned ₱1,500 from advanced payment.", "rows": 3, "solution": [ { "account": "Unearned Revenue", "debit": 1500 }, { "account": "Sales", "credit": 1500 }, { "account": "To record revenue earned.", "isExplanation": true } ] },
      { "date": "Feb 28", "description": "Inventory Shrinkage: Book ₱5,450, Count ₱5,400.", "rows": 3, "solution": [ { "account": "Cost of Goods Sold", "debit": 50 }, { "account": "Merchandise Inventory", "credit": 50 }, { "account": "Shrinkage adj.", "isExplanation": true } ] }
    ]
  },
  {
    "type": "worksheet",
    "id": "WS-SET-C-PERPETUAL-FIFO",
    "title": "Worksheet Activity: Set C (Perpetual FIFO)",
    "instructions": "Complete the worksheet using the PERPETUAL inventory system. Remember to record two entries for every sale transaction.",
    "transactions": [
      { "date": "Mar 1", "description": "Owner invested ₱120,000 cash.", "rows": 3, "solution": [ { "account": "Cash", "debit": 120000 }, { "account": "Owner's Capital", "credit": 120000 }, { "account": "Investment.", "isExplanation": true } ] },
      { "date": "Mar 2", "description": "Prepaid 3 months rent ₱9,000.", "rows": 3, "solution": [ { "account": "Prepaid Rent", "debit": 9000 }, { "account": "Cash", "credit": 9000 }, { "account": "Prepaid rent.", "isExplanation": true } ] },
      { "date": "Mar 4", "description": "Purchased inventory ₱30,000 cash.", "rows": 3, "solution": [ { "account": "Merchandise Inventory", "debit": 30000 }, { "account": "Cash", "credit": 30000 }, { "account": "Cash purchase.", "isExplanation": true } ] },
      { "date": "Mar 5", "description": "Purchased inventory ₱20,000 on account.", "rows": 3, "solution": [ { "account": "Merchandise Inventory", "debit": 20000 }, { "account": "Accounts Payable", "credit": 20000 }, { "account": "Credit purchase.", "isExplanation": true } ] },
      { "date": "Mar 7", "description": "Sold goods ₱45,000 on account (Cost ₱25,000).", "rows": 5, "solution": [ { "account": "Accounts Receivable", "debit": 45000 }, { "account": "Sales", "credit": 45000 }, { "account": "Cost of Goods Sold", "debit": 25000 }, { "account": "Merchandise Inventory", "credit": 25000 }, { "account": "Sale and COGS.", "isExplanation": true } ] },
      { "date": "Mar 9", "description": "Paid freight out ₱800.", "rows": 3, "solution": [ { "account": "Freight Out", "debit": 800 }, { "account": "Cash", "credit": 800 }, { "account": "Delivery.", "isExplanation": true } ] },
      { "date": "Mar 10", "description": "Returned defective goods to supplier ₱1,000.", "rows": 3, "solution": [ { "account": "Accounts Payable", "debit": 1000 }, { "account": "Merchandise Inventory", "credit": 1000 }, { "account": "Purchase return.", "isExplanation": true } ] },
      { "date": "Mar 12", "description": "Purchased Office Equipment ₱15,000.", "rows": 3, "solution": [ { "account": "Office Equipment", "debit": 15000 }, { "account": "Cash", "credit": 15000 }, { "account": "Bought equipment.", "isExplanation": true } ] },
      { "date": "Mar 15", "description": "Customer returned goods ₱2,000 (Cost ₱1,100).", "rows": 5, "solution": [ { "account": "Sales Returns and Allowances", "debit": 2000 }, { "account": "Accounts Receivable", "credit": 2000 }, { "account": "Merchandise Inventory", "debit": 1100 }, { "account": "Cost of Goods Sold", "credit": 1100 }, { "account": "Sales return.", "isExplanation": true } ] },
      { "date": "Mar 18", "description": "Collected ₱30,000 from accounts receivable.", "rows": 3, "solution": [ { "account": "Cash", "debit": 30000 }, { "account": "Accounts Receivable", "credit": 30000 }, { "account": "Collection.", "isExplanation": true } ] },
      { "date": "Mar 20", "description": "Paid ₱19,000 to supplier.", "rows": 3, "solution": [ { "account": "Accounts Payable", "debit": 19000 }, { "account": "Cash", "credit": 19000 }, { "account": "Payment.", "isExplanation": true } ] },
      { "date": "Mar 25", "description": "Sold goods ₱10,000 cash (Cost ₱6,000).", "rows": 5, "solution": [ { "account": "Cash", "debit": 10000 }, { "account": "Sales", "credit": 10000 }, { "account": "Cost of Goods Sold", "debit": 6000 }, { "account": "Merchandise Inventory", "credit": 6000 }, { "account": "Cash sale.", "isExplanation": true } ] },
      { "date": "Mar 28", "description": "Paid advertising ₱1,200.", "rows": 3, "solution": [ { "account": "Advertising Expense", "debit": 1200 }, { "account": "Cash", "credit": 1200 }, { "account": "Advertising.", "isExplanation": true } ] },
      { "date": "Mar 30", "description": "Paid salaries ₱4,000.", "rows": 3, "solution": [ { "account": "Salaries Expense", "debit": 4000 }, { "account": "Cash", "credit": 4000 }, { "account": "Salaries.", "isExplanation": true } ] },
      { "date": "Mar 31", "description": "Owner withdrew ₱2,000.", "rows": 3, "solution": [ { "account": "Owner's Drawings", "debit": 2000 }, { "account": "Cash", "credit": 2000 }, { "account": "Withdrawal.", "isExplanation": true } ] }
    ],
    "adjustments": [
      { "date": "Mar 31", "description": "Rent expired ₱3,000.", "rows": 3, "solution": [ { "account": "Rent Expense", "debit": 3000 }, { "account": "Prepaid Rent", "credit": 3000 }, { "account": "Rent adj.", "isExplanation": true } ] },
      { "date": "Mar 31", "description": "Depreciation ₱250.", "rows": 3, "solution": [ { "account": "Depreciation Expense", "debit": 250 }, { "account": "Accumulated Depreciation", "credit": 250 }, { "account": "Depreciation.", "isExplanation": true } ] },
      { "date": "Mar 31", "description": "Accrued Salaries ₱800.", "rows": 3, "solution": [ { "account": "Salaries Expense", "debit": 800 }, { "account": "Salaries Payable", "credit": 800 }, { "account": "Accrued salaries.", "isExplanation": true } ] },
      { "date": "Mar 31", "description": "Unused supplies counted ₱0 (No supplies bought).", "rows": 0, "solution": [ { "account": "No Entry", "debit": "" }, { "account": "No Entry", "credit": "" }, { "account": "No adjustment needed.", "isExplanation": true } ] },
      { "date": "Mar 31", "description": "Accrued Interest ₱100.", "rows": 3, "solution": [ { "account": "Interest Expense", "debit": 100 }, { "account": "Interest Payable", "credit": 100 }, { "account": "Interest.", "isExplanation": true } ] },
      { "date": "Mar 31", "description": "Bad Debts estimation ₱400.", "rows": 3, "solution": [ { "account": "Bad Debts Expense", "debit": 400 }, { "account": "Allowance for Bad Debts", "credit": 400 }, { "account": "Bad Debts.", "isExplanation": true } ] },
      { "date": "Mar 31", "description": "Inventory Shrinkage: Book ₱19,000, Count ₱18,800.", "rows": 3, "solution": [ { "account": "Cost of Goods Sold", "debit": 200 }, { "account": "Merchandise Inventory", "credit": 200 }, { "account": "Shrinkage.", "isExplanation": true } ] }
    ]
  },
  {
    "type": "worksheet",
    "id": "WS-SET-D-PERPETUAL-AVG",
    "title": "Worksheet Activity: Set D (Perpetual Moving Avg)",
    "instructions": "Complete the worksheet using PERPETUAL inventory with MOVING AVERAGE costing. COGS amounts are pre-calculated for you in the problem description.",
    "transactions": [
      { "date": "Apr 1", "description": "Invested ₱80,000 cash.", "rows": 3, "solution": [ { "account": "Cash", "debit": 80000 }, { "account": "Owner's Capital", "credit": 80000 }, { "account": "Investment.", "isExplanation": true } ] },
      { "date": "Apr 2", "description": "Purchased 1000 units @ ₱10 on account (₱10,000).", "rows": 3, "solution": [ { "account": "Merchandise Inventory", "debit": 10000 }, { "account": "Accounts Payable", "credit": 10000 }, { "account": "Purchase.", "isExplanation": true } ] },
      { "date": "Apr 4", "description": "Paid freight ₱500 cash.", "rows": 3, "solution": [ { "account": "Merchandise Inventory", "debit": 500 }, { "account": "Cash", "credit": 500 }, { "account": "Freight.", "isExplanation": true } ] },
      { "date": "Apr 6", "description": "Sold 400 units @ ₱25 on account. (Avg Cost ₱10.50, COGS ₱4,200).", "rows": 5, "solution": [ { "account": "Accounts Receivable", "debit": 10000 }, { "account": "Sales", "credit": 10000 }, { "account": "Cost of Goods Sold", "debit": 4200 }, { "account": "Merchandise Inventory", "credit": 4200 }, { "account": "Sale and COGS.", "isExplanation": true } ] },
      { "date": "Apr 8", "description": "Returned 50 units to supplier (Credit ₱500).", "rows": 3, "solution": [ { "account": "Accounts Payable", "debit": 500 }, { "account": "Merchandise Inventory", "credit": 500 }, { "account": "Return.", "isExplanation": true } ] },
      { "date": "Apr 10", "description": "Paid rent ₱2,000.", "rows": 3, "solution": [ { "account": "Rent Expense", "debit": 2000 }, { "account": "Cash", "credit": 2000 }, { "account": "Paid rent.", "isExplanation": true } ] },
      { "date": "Apr 12", "description": "Purchased 500 units @ ₱12 on account (₱6,000).", "rows": 3, "solution": [ { "account": "Merchandise Inventory", "debit": 6000 }, { "account": "Accounts Payable", "credit": 6000 }, { "account": "Purchase.", "isExplanation": true } ] },
      { "date": "Apr 15", "description": "Sold 600 units @ ₱28 cash. (New Avg ₱11.24, COGS ₱6,744).", "rows": 5, "solution": [ { "account": "Cash", "debit": 16800 }, { "account": "Sales", "credit": 16800 }, { "account": "Cost of Goods Sold", "debit": 6744 }, { "account": "Merchandise Inventory", "credit": 6744 }, { "account": "Sale.", "isExplanation": true } ] },
      { "date": "Apr 18", "description": "Customer returned 10 units (Cost ₱112).", "rows": 5, "solution": [ { "account": "Sales Returns and Allowances", "debit": 280 }, { "account": "Cash", "credit": 280 }, { "account": "Merchandise Inventory", "debit": 112 }, { "account": "Cost of Goods Sold", "credit": 112 }, { "account": "Return.", "isExplanation": true } ] },
      { "date": "Apr 20", "description": "Paid supplier ₱9,500.", "rows": 3, "solution": [ { "account": "Accounts Payable", "debit": 9500 }, { "account": "Cash", "credit": 9500 }, { "account": "Payment.", "isExplanation": true } ] },
      { "date": "Apr 22", "description": "Collected ₱10,000 from customer.", "rows": 3, "solution": [ { "account": "Cash", "debit": 10000 }, { "account": "Accounts Receivable", "credit": 10000 }, { "account": "Collection.", "isExplanation": true } ] },
      { "date": "Apr 25", "description": "Purchased Supplies ₱1,000.", "rows": 3, "solution": [ { "account": "Supplies", "debit": 1000 }, { "account": "Cash", "credit": 1000 }, { "account": "Supplies.", "isExplanation": true } ] },
      { "date": "Apr 28", "description": "Paid utilities ₱800.", "rows": 3, "solution": [ { "account": "Utilities Expense", "debit": 800 }, { "account": "Cash", "credit": 800 }, { "account": "Utilities.", "isExplanation": true } ] },
      { "date": "Apr 29", "description": "Paid salaries ₱3,000.", "rows": 3, "solution": [ { "account": "Salaries Expense", "debit": 3000 }, { "account": "Cash", "credit": 3000 }, { "account": "Salaries.", "isExplanation": true } ] },
      { "date": "Apr 30", "description": "Owner withdrew ₱2,500.", "rows": 3, "solution": [ { "account": "Owner's Drawings", "debit": 2500 }, { "account": "Cash", "credit": 2500 }, { "account": "Withdrawal.", "isExplanation": true } ] }
    ],
    "adjustments": [
      { "date": "Apr 30", "description": "Supplies on hand ₱400.", "rows": 3, "solution": [ { "account": "Supplies Expense", "debit": 600 }, { "account": "Supplies", "credit": 600 }, { "account": "Supplies used.", "isExplanation": true } ] },
      { "date": "Apr 30", "description": "Accrued Salaries ₱1,000.", "rows": 3, "solution": [ { "account": "Salaries Expense", "debit": 1000 }, { "account": "Salaries Payable", "credit": 1000 }, { "account": "Accrual.", "isExplanation": true } ] },
      { "date": "Apr 30", "description": "Depreciation ₱150.", "rows": 3, "solution": [ { "account": "Depreciation Expense", "debit": 150 }, { "account": "Accumulated Depreciation", "credit": 150 }, { "account": "Depreciation.", "isExplanation": true } ] },
      { "date": "Apr 30", "description": "Accrued Rent ₱500 (Payable).", "rows": 3, "solution": [ { "account": "Rent Expense", "debit": 500 }, { "account": "Accounts Payable", "credit": 500 }, { "account": "Accrual.", "isExplanation": true } ] },
      { "date": "Apr 30", "description": "Inventory Shrinkage: Book ₱5,168, Physical ₱5,100.", "rows": 3, "solution": [ { "account": "Cost of Goods Sold", "debit": 68 }, { "account": "Merchandise Inventory", "credit": 68 }, { "account": "Shrinkage.", "isExplanation": true } ] },
      { "date": "Apr 30", "description": "Bad debts 1% of sales (₱268).", "rows": 3, "solution": [ { "account": "Bad Debts Expense", "debit": 268 }, { "account": "Allowance for Bad Debts", "credit": 268 }, { "account": "Bad debts.", "isExplanation": true } ] },
      { "date": "Apr 30", "description": "Accrued Interest Income ₱100.", "rows": 3, "solution": [ { "account": "Interest Receivable", "debit": 100 }, { "account": "Interest Income", "credit": 100 }, { "account": "Interest Inc.", "isExplanation": true } ] }
    ]
  },
  {
    "type": "worksheet",
    "id": "WS-SET-E-PERPETUAL-AVG",
    "title": "Worksheet Activity: Set E (Perpetual Moving Avg)",
    "instructions": "Complete the worksheet using PERPETUAL inventory with MOVING AVERAGE costing. COGS amounts are pre-calculated for you.",
    "transactions": [
      { "date": "May 1", "description": "Invested ₱60,000 cash.", "rows": 3, "solution": [ { "account": "Cash", "debit": 60000 }, { "account": "Owner's Capital", "credit": 60000 }, { "account": "Investment.", "isExplanation": true } ] },
      { "date": "May 2", "description": "Purchased 500 units @ ₱20 cash (₱10,000).", "rows": 3, "solution": [ { "account": "Merchandise Inventory", "debit": 10000 }, { "account": "Cash", "credit": 10000 }, { "account": "Cash purchase.", "isExplanation": true } ] },
      { "date": "May 3", "description": "Purchased Equipment ₱20,000 on account.", "rows": 3, "solution": [ { "account": "Equipment", "debit": 20000 }, { "account": "Accounts Payable", "credit": 20000 }, { "account": "Equipment.", "isExplanation": true } ] },
      { "date": "May 5", "description": "Sold 200 units @ ₱40 on account (Avg Cost ₱20, COGS ₱4,000).", "rows": 5, "solution": [ { "account": "Accounts Receivable", "debit": 8000 }, { "account": "Sales", "credit": 8000 }, { "account": "Cost of Goods Sold", "debit": 4000 }, { "account": "Merchandise Inventory", "credit": 4000 }, { "account": "Sale.", "isExplanation": true } ] },
      { "date": "May 7", "description": "Paid advertising ₱1,000.", "rows": 3, "solution": [ { "account": "Advertising Expense", "debit": 1000 }, { "account": "Cash", "credit": 1000 }, { "account": "Advertising.", "isExplanation": true } ] },
      { "date": "May 9", "description": "Purchased 300 units @ ₱22 on account (₱6,600). New Avg ₱21.", "rows": 3, "solution": [ { "account": "Merchandise Inventory", "debit": 6600 }, { "account": "Accounts Payable", "credit": 6600 }, { "account": "Purchase.", "isExplanation": true } ] },
      { "date": "May 12", "description": "Sold 400 units @ ₱45 cash (Avg Cost ₱21, COGS ₱8,400).", "rows": 5, "solution": [ { "account": "Cash", "debit": 18000 }, { "account": "Sales", "credit": 18000 }, { "account": "Cost of Goods Sold", "debit": 8400 }, { "account": "Merchandise Inventory", "credit": 8400 }, { "account": "Sale.", "isExplanation": true } ] },
      { "date": "May 15", "description": "Paid supplier ₱6,600.", "rows": 3, "solution": [ { "account": "Accounts Payable", "debit": 6600 }, { "account": "Cash", "credit": 6600 }, { "account": "Payment.", "isExplanation": true } ] },
      { "date": "May 18", "description": "Customer returned 10 units (Avg Cost ₱21, ₱210).", "rows": 5, "solution": [ { "account": "Sales Returns and Allowances", "debit": 450 }, { "account": "Cash", "credit": 450 }, { "account": "Merchandise Inventory", "debit": 210 }, { "account": "Cost of Goods Sold", "credit": 210 }, { "account": "Return.", "isExplanation": true } ] },
      { "date": "May 20", "description": "Collected ₱8,000 from accounts receivable.", "rows": 3, "solution": [ { "account": "Cash", "debit": 8000 }, { "account": "Accounts Receivable", "credit": 8000 }, { "account": "Collection.", "isExplanation": true } ] },
      { "date": "May 22", "description": "Purchased supplies ₱1,500 cash.", "rows": 3, "solution": [ { "account": "Supplies", "debit": 1500 }, { "account": "Cash", "credit": 1500 }, { "account": "Supplies.", "isExplanation": true } ] },
      { "date": "May 25", "description": "Paid rent ₱1,800.", "rows": 3, "solution": [ { "account": "Rent Expense", "debit": 1800 }, { "account": "Cash", "credit": 1800 }, { "account": "Rent.", "isExplanation": true } ] },
      { "date": "May 28", "description": "Paid utilities ₱600.", "rows": 3, "solution": [ { "account": "Utilities Expense", "debit": 600 }, { "account": "Cash", "credit": 600 }, { "account": "Utilities.", "isExplanation": true } ] },
      { "date": "May 30", "description": "Paid salaries ₱3,500.", "rows": 3, "solution": [ { "account": "Salaries Expense", "debit": 3500 }, { "account": "Cash", "credit": 3500 }, { "account": "Salaries.", "isExplanation": true } ] },
      { "date": "May 31", "description": "Owner withdrew ₱4,000.", "rows": 3, "solution": [ { "account": "Owner's Drawings", "debit": 4000 }, { "account": "Cash", "credit": 4000 }, { "account": "Withdrawal.", "isExplanation": true } ] }
    ],
    "adjustments": [
      { "date": "May 31", "description": "Depreciation ₱400.", "rows": 3, "solution": [ { "account": "Depreciation Expense", "debit": 400 }, { "account": "Accumulated Depreciation", "credit": 400 }, { "account": "Depreciation.", "isExplanation": true } ] },
      { "date": "May 31", "description": "Supplies on hand ₱500.", "rows": 3, "solution": [ { "account": "Supplies Expense", "debit": 1000 }, { "account": "Supplies", "credit": 1000 }, { "account": "Supplies adj.", "isExplanation": true } ] },
      { "date": "May 31", "description": "Accrued Salaries ₱800.", "rows": 3, "solution": [ { "account": "Salaries Expense", "debit": 800 }, { "account": "Salaries Payable", "credit": 800 }, { "account": "Accrued salaries.", "isExplanation": true } ] },
      { "date": "May 31", "description": "Accrued Utilities ₱200.", "rows": 3, "solution": [ { "account": "Utilities Expense", "debit": 200 }, { "account": "Utilities Payable", "credit": 200 }, { "account": "Accrual.", "isExplanation": true } ] },
      { "date": "May 31", "description": "Accrued Interest ₱150.", "rows": 3, "solution": [ { "account": "Interest Expense", "debit": 150 }, { "account": "Interest Payable", "credit": 150 }, { "account": "Interest.", "isExplanation": true } ] },
      { "date": "May 31", "description": "Shrinkage: Book ₱4,410, Physical ₱4,300.", "rows": 3, "solution": [ { "account": "Cost of Goods Sold", "debit": 110 }, { "account": "Merchandise Inventory", "credit": 110 }, { "account": "Shrinkage.", "isExplanation": true } ] },
      { "date": "May 31", "description": "Estimated Bad Debts ₱250.", "rows": 3, "solution": [ { "account": "Bad Debts Expense", "debit": 250 }, { "account": "Allowance for Bad Debts", "credit": 250 }, { "account": "Bad debts.", "isExplanation": true } ] }
    ]
  }
]
        },
